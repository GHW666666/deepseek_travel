...
class ChatController {
    async chatMessage(ctx) {
        ...
        for await (const chunk of completion) {
            ...
            if (obj.choices[0].finish_reason === "tool_calls" && !hasSentFunction) {
                console.log("工具名称:", functionName);
                console.log("工具ID:", toolCallId);
                ...
                ctx.res.end();
                hasSentFunction = true;
                return;
            }

            if (choice.content && !hasSentFunction) {
